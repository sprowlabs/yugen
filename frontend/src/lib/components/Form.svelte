...
<form class="signup-form">
    ...
    <div class="datainput">
        <input class="validate" id="wa_name" name="name" type="text" bind:value={$user.name}/>
        <span class="highlight"></span><span class="bar"></span>
        <label>Name</label>
    </div>

    <div class="datainput">
        <input class="validate" id="wa_email" name="email" type="email" bind:value={$user.username}/>
        <span class="highlight"></span><span class="bar"></span>
